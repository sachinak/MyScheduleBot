class Event:
    """
    Function: __init__
    Description: Creates a new Event object instance
    Input:
    ...
    """
    Function: __str__
    Description: Converts an Event object into a string
    Input:
        self - The current Event object instance
    Output: A formatted string that represents all the information about an Event instance
    """
    ...
    """
    Function: __lt__
    Description: Finds whether the current event starts before another
    Input:
        self - The current Event object instance
    ...
    """
    Function: __le__
    Description: Finds whether the current event starts before or at the same time as another
    Input:
        self - The current Event object instance
        other - The Event object we are comparing self to
    Output:
    ...
    """
    Function: __gt__
    Description: Finds whether the current event starts after another
    Input:
        self - The current Event object instance
        other - The Event object we are comparing self to
    Output:
    ...
    """
    Function: __ge__
    Description: Finds whether the current event starts after or at the same time as another
    Input:
        self - The current Event object instance
        other - The Event object we are comparing self to
    Output:
    ...
    """
    Function: intersect
    Description: Finds whether the current event intersects another in one of 4 possible ways:
    ...
    """
    Function: to_list
    Description: Converts an Event object into a list
    Input:
        self - The current Event object instance
    Output:
