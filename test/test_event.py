...
def create_event_1():
    ...
    return Event( "Make test cases", start, end, "homework", "Make test cases for my code in SE" )

def create_event_2():
    start = datetime(2021, 9, 30, 0, 0)
    end = datetime(2021, 9, 30, 23, 59)
    return Event( "SE project", start, end, "homework", "Finish it" )

def create_event_3():
    start = datetime(2021, 9, 30, 14, 0)
    end = datetime(2021, 9, 30, 15, 0)
    return Event( "Coffee time", start, end, "recess", "Enjoy" )

def create_event_4():
    start = datetime(2021, 9, 29, 23, 0)
    end = datetime(2021, 9, 30, 10, 0)
    return Event( "Sleep", start, end, "recess", "zzz" )

def create_event_5():
    start = datetime(2021, 9, 30, 23, 0)
    end = datetime(2021, 10, 1, 10, 0)
    return Event( "Sleep 2", start, end, "recess", "zzz" )

def test_str_1():
    assert str(create_event_1()) == "Make test cases 2021-09-29 20:21:00 2021-09-29 22:21:00 homework Make test cases for my code in SE"

def test_str_2():
    assert str(create_event_2()) == "SE project 2021-09-30 00:00:00 2021-09-30 23:59:00 homework Finish it"
...
def test_to_list():
    e1 = create_event_1()
    list_1 = [ e1.name, e1.start_date, e1.end_date, e1.event_type, e1.description ]
